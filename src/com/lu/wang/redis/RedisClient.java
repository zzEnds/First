...
public class RedisClient {
	...
	private Jedis jedis;//非切片额客户端连接池
	private JedisPool jedisPool;//非切片连接池
	private ShardedJedis shardedJedis;//切片额客户端连接池
	...
	private void initialPool() {
		...
		poolCfg.setMaxActive(20);
		poolCfg.setMaxIdle(5);
		poolCfg.setMaxWait(maxWait);
	...
	private void initialShardedPool() {
		...
		//构造池
		shardedJedisPool = new ShardedJedisPool(poolCfg, shards);
